...
class Derived:
    # takes two optional Argument; publicKey and nodeURL.
    # By default NodeURL is https://node.deso.org/api/v0/"
    ...
    def authorizeDerivedKey(
        ...
        """
        Authorizes derived key generated by a publicKey.
        Set isAuth = False to deauthorize it
        """
        try:
            error = None
            payload = {
            ...
            try:
                ...
                error = {
                    "error": "Something went wrong while signing the "
                    "transactions. Make sure public key, derived key "
                    "and derivedSeedHex are correct.\n"
                    "Also, Make sure the derived Key hasAUTHORIZE_DERIVED_KEY"
                    "permission as well"
                }
                raise e(error["error"])
